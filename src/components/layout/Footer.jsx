...
export default function Footer() {
  return (
    <footer className="bg-[#000000] border-t border-[rgba(255,255,255,0.12)] pt-20 pb-12 text-[#8D9398] text-sm">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          
          {/* Brand Col with official aerodynamic emblem (lg:col-span-5) */}
          <div className="lg:col-span-5 space-y-4">
            <Link to="/" className="block py-1 text-[#FFFFFF] hover:text-[#E10600] transition-colors max-w-[280px]">
            ...
            <div className="font-mono text-[10px] tracking-widest text-[#E10600] uppercase font-medium">
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs font-body font-normal">
              {studioServices.map(s => (
                <li key={s.id}>
                  <Link to="/services" className="hover:text-[#E10600] transition-colors flex items-center gap-2">
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="space-y-2 text-xs font-body">
              <div>
                ...
                <a href={`tel:${studioCompany.phones.primary}`} className="font-display text-lg font-bold text-[#FFFFFF] hover:text-[#E10600] tracking-tight">
              ...
              <div className="pt-1">
                ...
                <a href={`mailto:${studioCompany.email}`} className="text-xs text-[#FFFFFF] hover:text-[#E10600] font-semibold">
                  {studioCompany.email}
                </a>
              </div>
            </div>
        ...
        <div className="border-t border-[rgba(255,255,255,0.08)] pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] font-mono text-[#8D9398] font-medium">
          ...
          <div className="flex gap-6">
            <a href="#" className="hover:text-[#E10600] transition-colors">PRIVACY PROTOCOL</a>
            <a href="#" className="hover:text-[#E10600] transition-colors">TERMS OF SERVICE</a>
            <a href="#" className="hover:text-[#E10600] transition-colors">WARRANTY</a>
          </div>
        </div>
      </div>
    </footer>
