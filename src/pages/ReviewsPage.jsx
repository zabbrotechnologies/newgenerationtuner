    ...
    <div className="py-24 md:py-32 bg-[#000000] text-[#FAFAFA]">
      <div className="container space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {REVIEWS.map(rev => (
            <div key={rev.id} className="bg-[#080808] border border-[rgba(255,255,255,0.12)] p-8 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex gap-1 text-[#E10600]">
                  {[...Array(rev.rating)].map((_, i) => (
                    <Star key={i} size={14} fill="#E10600" />
                  ))}
                </div>
              ...
              <div className="pt-4 border-t border-[rgba(255,255,255,0.08)] space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  {rev.verified && <CheckCircle2 size={14} className="text-[#E10600]" />}
                </div>
                <div className="font-mono text-xs text-[#E10600] font-bold">{rev.vehicle}</div>
        ...
        {/* Bottom CTA */}
        <div className="bg-[#080808] border border-[rgba(255,255,255,0.12)] p-12 text-center space-y-4 max-w-3xl mx-auto">
