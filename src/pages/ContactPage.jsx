          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-6 pt-6 border-t border-[rgba(255,255,255,0.08)]">
              <div>
                ...
                <a href={`tel:${studioCompany.phones.primary}`} className="font-display text-3xl sm:text-4xl font-bold text-[#FFFFFF] hover:text-[#D71920] transition-colors tracking-tight">
              ...
              <div>
                ...
                <div className="font-body text-sm text-[#FFFFFF] space-y-1 font-medium">
                  <div><a href={`tel:${studioCompany.phones.direct}`} className="hover:text-[#D71920] transition-colors">{studioCompany.phones.direct}</a></div>
                  <div><a href={`tel:${studioCompany.phones.support}`} className="hover:text-[#D71920] transition-colors">{studioCompany.phones.support}</a></div>
                </div>
              </div>
              ...
              <div>
                ...
                <a href={`mailto:${studioCompany.email}`} className="font-body text-sm text-[#FFFFFF] hover:text-[#D71920] transition-colors font-semibold">
                  {studioCompany.email}
                </a>
              </div>
            </div>
