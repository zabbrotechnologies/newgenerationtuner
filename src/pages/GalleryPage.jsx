      ...
      <div className="container space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredItems.map(proj => (
            <div key={proj.id} className="bg-[#181B1E] border border-[rgba(255,255,255,0.12)] group overflow-hidden">
              <div className="aspect-[16/10] overflow-hidden relative">
                ...
                />
                <span className="absolute top-4 left-4 font-mono text-[9px] tracking-widest uppercase bg-[#101214]/95 border border-[rgba(255,255,255,0.12)] px-3 py-1 text-[#D71920] font-bold">
                  {proj.category}
                </span>
              </div>
              ...
              <div className="p-8 space-y-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="font-display text-2xl font-bold uppercase tracking-tight text-[#FFFFFF] group-hover:text-[#D71920] transition-colors">
                      {proj.title}
                    </h3>
                ...
                <div className="pt-4 border-t border-[rgba(255,255,255,0.08)] flex flex-wrap gap-2">
                  {proj.metrics.map((m, i) => (
                    <span key={i} className="font-mono text-[10px] text-[#8D9398] bg-[#101214] px-2.5 py-1 border border-[rgba(255,255,255,0.06)]">
                      ✓ {m}
                    </span>
                  ))}
                </div>
